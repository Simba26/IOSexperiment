...
class ViewController: UIViewController,UITableViewDelegate,UITableViewDataSource{
    ...
    let stuONe=Student(firstName: "敏", lastName: "安", age: 20, gender: .female, stuNo: "0001")
    let stuTwo=Student(firstName: "敏", lastName: "安", age: 20, gender: .female, stuNo: "0002")
    let stuThree=Student(firstName: "三", lastName: "张", age: 22, gender: .male, stuNo: "0003")
    let stuFour=Student(firstName: "四", lastName: "李", age: 21, gender: .male, stuNo: "0004")
